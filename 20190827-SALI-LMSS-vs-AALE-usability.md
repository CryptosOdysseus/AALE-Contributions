...
In [Part D](https://github.com/CryptosOdysseus/AALE-Contributions/blob/master/20190827-SALI-LMSS-vs-AALE-usability.md#part-d---fully-expanded-sali-lmss-tree-structure-and-detailed-parameters-of-sali-lmss-structure-and-code-browsers) we provided a fully expanded SALI LMSS tree structure and detailed parameters of SALI LMSS structure and code browsers. Going through the fine print shows where parameters generated by new AAS ontologies in a human-AAS interaction and attribution context, starting obvioulsy with:
